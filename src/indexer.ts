...
export class Indexer implements IndexerInterface {
  ...
  _populateEntityTypesMap (): void {
    ...
    this._entityTypesMap.set('TaskReceiptWrapper', {
      id: 'ID',
      user: 'User',
    ...
    this._entityTypesMap.set('TaskReceipt', {
      id: 'ID',
      userProxy: 'Bytes',
      provider: 'Provider',
      index: 'BigInt',
    ...
    this._entityTypesMap.set('TaskCycle', {
      id: 'ID',
      taskReceiptWrappers: 'TaskReceiptWrapper'
    });
    this._entityTypesMap.set('Task', {
      id: 'ID',
    ...
    this._entityTypesMap.set('Provider', {
      id: 'ID',
      addr: 'Bytes',
      module: 'Bytes',
      taskCount: 'BigInt'
    });
    this._entityTypesMap.set('Condition', {
      id: 'ID',
      inst: 'Bytes',
      data: 'Bytes'
    });
    this._entityTypesMap.set('Action', {
      id: 'ID',
      addr: 'Bytes',
      data: 'Bytes',
      operation: 'BigInt',
    ...
    this._entityTypesMap.set('Executor', {
      id: 'ID',
      addr: 'Bytes'
    });
  }
  ...
  _populateRelationsMap (): void {
    this._relationsMap.set(TaskReceiptWrapper, {
      user: {
        entity: User,
        isArray: false,
        isDerived: false
    ...
    this._relationsMap.set(TaskReceipt, {
      provider: {
        entity: Provider,
        isArray: false,
        isDerived: false
    ...
    this._relationsMap.set(TaskCycle, {
      taskReceiptWrappers: {
        entity: TaskReceiptWrapper,
        isArray: true,
        isDerived: false
      }
    });
    this._relationsMap.set(Task, {
      conditions: {
        entity: Condition,
        isArray: true,
        isDerived: false
